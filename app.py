...
if opcion == "Home":
   ...
   if "pills_selection_key" not in st.session_state:
       st.session_state["pills_selection_key"] = None
   ...
   pills_selection = st.pills("Opción", ["Agregar", "Evaluar actividades"], selection_mode="single", key="pills_selection_key")
